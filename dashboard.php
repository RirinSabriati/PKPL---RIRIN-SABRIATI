  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= base_url('dashboard') ?>" class="brand-link">
        <img src="<?= base_url('assets/img/') ?>logotbq.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">TBQ UAD</span>
      </a>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <h1>Selamat datang di TBQ UAD</h1>
          </div>
          <!-- /.row -->
          <!-- Main row -->
          <div class="row">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021 TBQ UAD.</strong>
      All rights reserved.
